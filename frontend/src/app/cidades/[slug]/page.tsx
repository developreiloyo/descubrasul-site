...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: `Negócios em ${cidade} | DescubraSul`,
    description: `Descubra os melhores negócios de ${cidade}: restaurantes, lojas, serviços e muito mais. Fale direto pelo WhatsApp no DescubraSul.`,
    alternates: { canonical: url },
    openGraph: {
      title: `Negócios em ${cidade} | DescubraSul`,
      description: `O comércio de ${cidade} está no DescubraSul.`,
      url,
    },
  };
}
    ...
    <div className="min-h-screen bg-surface">
      ...
      <main className="mx-auto max-w-6xl px-4 py-8">
        <header className="py-8">
          <h1 className="text-3xl font-bold">Negócios em {cidade}</h1>
          <p className="mt-2 text-ink/60">
            {negocios.length === 0
              ? `Em breve, o comércio de ${cidade} estará aqui.`
              : `${negocios.length} negócio(s) em ${cidade}, organizados por categoria.`}
          </p>
        </header>
