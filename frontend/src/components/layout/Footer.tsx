    ...
    <footer className="bg-ink text-white">
      <div className="mx-auto max-w-6xl px-4 py-12">
        <div className="grid grid-cols-2 gap-8 md:grid-cols-4">
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2 text-sm">
              ...
              <li><Link href="/para-empresas" className="text-white/70 hover:text-white transition-colors">Para Empresas</Link></li>
              <li><Link href="/painel/cadastro" className="text-white/70 hover:text-white transition-colors">Cadastre seu negócio</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2 text-sm">
              <li><Link href="/termos" className="text-white/70 hover:text-white transition-colors">Termos de Uso</Link></li>
              <li><Link href="/privacidade" className="text-white/70 hover:text-white transition-colors">Privacidade</Link></li>
              <li><Link href="/privacidade" className="text-white/70 hover:text-white transition-colors">Proprietário</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2 text-sm">
              <li>
                <a href="mailto:contato@descubrasul.com" className="text-white/70 hover:text-white transition-colors">
                  contato@descubrasul.com
                </a>
              </li>
              <li>
                <a href="mailto:privacidade@descubrasul.com" className="text-white/70 hover:text-white transition-colors">
        ...
        <div className="mt-12 border-t border-white/10 pt-8 text-center text-sm text-white/40">
          © {new Date().getFullYear()} DescubraSul — Sul de Santa Catarina, Brasil
        </div>
      </div>
    </footer>
  );
